...
const secondRowCliente = [
    {titulo: 'Administre productos que consumiran sus pacientes', descripcion: 'Nuestra lista de productos contiene varias comidas y bebidas que puede integrar dentro de las dietas de los clientes. Desde nuestra pagina usted podra encontrar informacion que le servira al paciente a la hora de conseguir las comidas para su dieta', imagen: ProductosCardImg,},
    {titulo: 'Consulte el perfil de su paciente', descripcion: 'Ya sea comentarios, reviews, notas, logs de actividades, etc. Nutrihome provee varias herramientas para facilitar y optimizar la comunicacion con sus pacientes. Independicese de las aplicaciones o paginas externas y facilite el contacto con su cliente', imagen: ComunicacionCardImg,},
